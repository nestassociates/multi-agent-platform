/**
 * TypeScript types for Postcode Sector Territory feature
...
/**
 * POST /api/admin/territories request (extended)
 */
export interface TerritoryAssignmentRequest {
  agent_id: string;
  postcode_code: string;
  sector_codes?: string[] | null;  // NEW: specific sectors (null = full district)
}
...
// ============================================
// GeoJSON Types (subset for boundaries)
// ============================================
